...
*/
bool StatesMachines::navigationSM()
{
	//reset the states of the state machine
	resetStates();

	//add states to the state machine
	addState((int)NavigationSM::InitialState, NavigationSM::initialStateFunc);
	addState((int)NavigationSM::DoSomethingState, NavigationSM::doSomethingFunc);
	addState((int)NavigationSM::FinalState, NavigationSM::finalStateFunc, true);
